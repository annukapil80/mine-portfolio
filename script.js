...
document.addEventListener('DOMContentLoaded', () => {
    const elementsToAnimate = document.querySelectorAll('.skill-category, .service-card, .project-card, .contact-item, .stat');
...
function showNotification(message, type = 'info') {
    ...
    notification.style.cssText = `
        ...
        top: 20px;
        right: 20px;
        background: ${type === 'error' ? '#ff4444' : type === 'success' ? '#00d4ff' : '#0099cc'};
        color: white;
        padding: 1rem 1.5rem;
        border-radius: 8px;
...
// Add pulse animation for tech badges
